...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.heading.1.markdown', { fg = c.vscLightBlue, bg = "NONE", bold = true })
    hl(0, '@markup.heading.2.markdown', { fg = c.vscBlueGreen, bg = "NONE", bold = true })
    hl(0, '@markup.heading.3.markdown', { fg = c.vscBlue, bg = "NONE", bold = true })
    hl(0, '@markup.heading.4.markdown', { fg = c.vscGreen, bg = "NONE", bold = true })
    hl(0, '@markup.heading.5.markdown', { fg = c.vscOrange, bg = "NONE", bold = true })
    ...
    hl(0, 'RenderMarkdownH1', { fg = c.vscLightBlue, bold = true })
    hl(0, 'RenderMarkdownH2', { fg = c.vscBlueGreen, bold = true })
    hl(0, 'RenderMarkdownH3', { fg = c.vscBlue, bold = true })
    hl(0, 'RenderMarkdownH4', { fg = c.vscGreen, bold = true })
    hl(0, 'RenderMarkdownH5', { fg = c.vscOrange, bold = true })
