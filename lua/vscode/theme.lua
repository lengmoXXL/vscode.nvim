...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.link', { fg = c.vscViolet })
    hl(0, "@lsp.type.decorator.markdown", { fg = c.vscViolet, underline = true })
    ...
    hl(0, 'RenderMarkdownWikiLink', { fg = c.vscViolet, underline = true })
    hl(0, 'RenderMarkdownLink', { fg = c.vscViolet })
    hl(0, 'RenderMarkdownLinkTitle', { fg = c.vscViolet })
