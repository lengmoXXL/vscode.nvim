...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.heading.2.markdown', { fg = c.vscGreen, bg = "NONE", bold = true })
    ...
    hl(0, 'RenderMarkdownH2', { fg = c.vscGreen, bold = true })
    ...
    hl(0, 'RenderMarkdownCode', { bg = c.vscFoldBackground })
    hl(0, 'RenderMarkdownCodeInline', { bg = c.vscFoldBackground })
