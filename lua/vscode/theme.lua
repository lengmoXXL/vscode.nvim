...
theme.set_highlights = function(opts)
    ...
    hl(0, "@lsp.type.decorator.markdown", { fg = c.vscGreen, underline = true })
    ...
    hl(0, 'RenderMarkdownWikiLink', { fg = c.vscGreen, underline = true })
    hl(0, 'RenderMarkdownLink', { fg = c.vscGreen })
    hl(0, 'RenderMarkdownLinkTitle', { fg = c.vscGreen })
