...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.heading.4.markdown', { fg = c.vscBlue, bg = "NONE", bold = true })
    hl(0, '@markup.heading.5.markdown', { fg = c.vscPink, bg = "NONE", bold = true })
    ...
    hl(0, 'RenderMarkdownH4', { fg = c.vscBlue, bold = true })
    hl(0, 'RenderMarkdownH5', { fg = c.vscPink, bold = true })
