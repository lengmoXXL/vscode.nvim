...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.heading.2.markdown', { fg = c.vscPink, bg = "NONE", bold = true })
    hl(0, '@markup.heading.3.markdown', { fg = c.vscGreen, bg = "NONE", bold = true })
    hl(0, '@markup.heading.4.markdown', { fg = c.vscAccentBlue, bg = "NONE", bold = true })
    ...
    hl(0, 'RenderMarkdownH2', { fg = c.vscPink, bold = true })
    hl(0, 'RenderMarkdownH3', { fg = c.vscGreen, bold = true })
    hl(0, 'RenderMarkdownH4', { fg = c.vscAccentBlue, bold = true })
