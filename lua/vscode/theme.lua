...
theme.set_highlights = function(opts)
    ...
    hl(0, '@markup.link', { fg = c.vscViolet, underline = true })
    hl(0, '@markup.link.label', { fg = c.vscViolet, underline = true })
    hl(0, '@markup.link.url', { fg = c.vscViolet, underline = true })
    ...
    hl(0, 'RenderMarkdownLink', { fg = c.vscViolet, underline = true })
    hl(0, 'RenderMarkdownWikiLink', { fg = c.vscViolet, underline = true })
    hl(0, 'RenderMarkdownLinkTitle', { fg = c.vscViolet, underline = true })
