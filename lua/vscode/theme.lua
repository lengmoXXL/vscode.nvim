...
theme.set_highlights = function(opts)
    ...
    hl(0, 'StatusLine', { fg = c.vscFront, bg = c.vscUiBlue })
    hl(0, 'StatusLineNC', { fg = c.vscFront, bg = c.vscUiBlue })
    ...
    hl(0, '@attribute', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@module', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@function', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@function.builtin', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, '@function.call', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@function.macro', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, '@function.method', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@function.method.call', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@define', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@variable', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscFont, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscFont, bg = 'NONE' })
    ...
    hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@type', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, '@markup.strong', { fg = c.vscFront, bold = true })
    ...
    hl(0, '@markup.heading.2.markdown', { fg = c.vscViolet, bg = "NONE", bold = true })
    hl(0, '@markup.heading.3.markdown', { fg = c.vscBlueGreen, bg = "NONE", bold = true })
    hl(0, '@markup.heading.4.markdown', { fg = c.vscOrange, bg = "NONE", bold = true })
    hl(0, '@markup.heading.5.markdown', { fg = c.vscLightBlue, bg = "NONE", bold = true })
    hl(0, '@markup.heading.6.markdown', { fg = c.vscYellow, bg = "NONE", bold = true })
    hl(0, '@markup.raw', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@markup.link', { fg = c.vscDarkGreen })
    hl(0, "@lsp.type.decorator.markdown", { fg = c.vscDarkGreen, underline = true })
    hl(0, '@markup.list', { fg = c.vscFont, bg = 'NONE' })
    hl(0, '@markup.quote.markdown', { fg = c.vscGray })
    hl(0, '@textReference', { fg = isDark and c.vscBlue or c.vscYellowOrange })
    ...
    hl(0, 'markdownLinkText', { fg = isDark and c.vscBlue or c.vscYellowOrange })
    hl(0, 'markdownEscape', { fg = isDark and c.vscBlue or c.vscYellowOrange })
    hl(0, 'RenderMarkdownH1', { fg = c.vscBlue, bold = true })
    hl(0, 'RenderMarkdownH2', { fg = c.vscViolet, bold = true })
    hl(0, 'RenderMarkdownH3', { fg = c.vscBlueGreen, bold = true })
    hl(0, 'RenderMarkdownH4', { fg = c.vscOrange, bold = true })
    hl(0, 'RenderMarkdownH5', { fg = c.vscLightBlue, bold = true })
    hl(0, 'RenderMarkdownH6', { fg = c.vscYellow, bold = true })
    hl(0, 'RenderMarkdownH1Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownH2Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownH3Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownH4Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownH5Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownH6Bg', { bg = c.vscPopupBack, bold = true })
    hl(0, 'RenderMarkdownCode', { bg = c.vscTabOther })
    hl(0, 'RenderMarkdownCodeInline', { bg = c.vscContext })
    hl(0, 'RenderMarkdownBullet', { fg = c.vscFront })
    hl(0, 'RenderMarkdownWikiLink', { fg = c.vscDarkGreen, underline = true })
    hl(0, 'RenderMarkdownLink', { fg = c.vscDarkGreen })
    hl(0, 'RenderMarkdownLinkTitle', { fg = c.vscDarkGreen })
    hl(0, 'RenderMarkdownQuote1', { fg = c.vscGray })
    hl(0, 'RenderMarkdownQuote2', { fg = c.vscGray })
    hl(0, 'RenderMarkdownQuote3', { fg = c.vscGray })
    hl(0, 'RenderMarkdownQuote4', { fg = c.vscGray })
    hl(0, 'RenderMarkdownQuote5', { fg = c.vscGray })
    hl(0, 'RenderMarkdownQuote6', { fg = c.vscGray })
    ...
    hl(0, 'DiagnosticWarn', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'DiagnosticInfo', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'DiagnosticHint', { fg = c.vscGreen, bg = 'NONE' })
