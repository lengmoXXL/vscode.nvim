...
theme.set_highlights = function(opts)
    ...
    hl(0, '@attribute', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, '@markup.link', { fg = c.vscOrange, bg = 'NONE', underline = false })
    hl(0, '@markup.link.label', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@markup.link.url', { fg = c.vscFront, bg = 'NONE', underline = opts.underline_links })
    hl(0, '@markup.list.checked', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@markup.list.unchecked', { fg = c.vscBlue, bg = 'NONE' })
